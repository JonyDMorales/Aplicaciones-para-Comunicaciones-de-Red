...
public class OthelloS extends JFrame implements ActionListener{
    static String host = "127.0.0.1";
    static int pto = 9999;
    JEditorPane editorPane; 
    static final String WindowTitle = "OthelloS";
	...
	setupMenuBar();
	gpanel.setMinimumSize(new Dimension(OthelloS.Width,OthelloS.Height));
	...
	about.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
            ImageIcon icon = new ImageIcon(OthelloS.class.getResource("reversi.jpg"));
	...
	public void hyperlinkUpdate(HyperlinkEvent e) {
        ...
        java.net.URL helpURL = OthelloS.class.getResource("HelpFile.html");
        if (helpURL != null) {
            try {
            ...
            while(true){
              	...
              	while(it.hasNext()){
                    ...
                    if(k.isReadable()){
                        ...
                        gpanel.setLlego(true);
                        gpanel.SetCliente(i,j);
                        if(board.gameEnd()){  	
                            ch.close();
                            System.exit(0);
                       	}else{
                            int aux [] = gpanel.recibe();
                            String en = aux[0]+ " " + aux[1];
                            b = ByteBuffer.wrap(en.getBytes());
                            ch.write(b);
                        }
                    }//if_readable
                }//while
